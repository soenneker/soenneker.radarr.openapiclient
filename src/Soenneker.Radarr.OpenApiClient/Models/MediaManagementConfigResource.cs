...
namespace Soenneker.Radarr.OpenApiClient.Models
{
    ...
    {
        /// <summary>The autoRenameFolders property</summary>
        public bool? AutoRenameFolders { get; set; }
        /// <summary>The autoUnmonitorPreviouslyDownloadedMovies property</summary>
...
#nullable restore
        ...
        /// <summary>The createEmptyMovieFolders property</summary>
        ...
        public global::Soenneker.Radarr.OpenApiClient.Models.ProperDownloadTypes? DownloadPropersAndRepacks { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Radarr.OpenApiClient.Models.FileDateType? FileDate { get; set; }
        ...
        /// <summary>The pathsDefaultStatic property</summary>
...
#nullable restore
        ...
        public global::Soenneker.Radarr.OpenApiClient.Models.RescanAfterRefreshType? RescanAfterRefresh { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Radarr.OpenApiClient.Models.MediaManagementConfigResource"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Radarr.OpenApiClient.Models.MediaManagementConfigResource CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Radarr.OpenApiClient.Models.MediaManagementConfigResource();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "autoRenameFolders", n => { AutoRenameFolders = n.GetBoolValue(); } },
                { "autoUnmonitorPreviouslyDownloadedMovies", n => { AutoUnmonitorPreviouslyDownloadedMovies = n.GetBoolValue(); } },
                ...
                { "createEmptyMovieFolders", n => { CreateEmptyMovieFolders = n.GetBoolValue(); } },
                { "deleteEmptyFolders", n => { DeleteEmptyFolders = n.GetBoolValue(); } },
                { "downloadPropersAndRepacks", n => { DownloadPropersAndRepacks = n.GetEnumValue<global::Soenneker.Radarr.OpenApiClient.Models.ProperDownloadTypes>(); } },
                { "enableMediaInfo", n => { EnableMediaInfo = n.GetBoolValue(); } },
                { "extraFileExtensions", n => { ExtraFileExtensions = n.GetStringValue(); } },
                { "fileDate", n => { FileDate = n.GetEnumValue<global::Soenneker.Radarr.OpenApiClient.Models.FileDateType>(); } },
                ...
                { "pathsDefaultStatic", n => { PathsDefaultStatic = n.GetBoolValue(); } },
                { "recycleBin", n => { RecycleBin = n.GetStringValue(); } },
                { "recycleBinCleanupDays", n => { RecycleBinCleanupDays = n.GetIntValue(); } },
                { "rescanAfterRefresh", n => { RescanAfterRefresh = n.GetEnumValue<global::Soenneker.Radarr.OpenApiClient.Models.RescanAfterRefreshType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteBoolValue("autoRenameFolders", AutoRenameFolders);
            writer.WriteBoolValue("autoUnmonitorPreviouslyDownloadedMovies", AutoUnmonitorPreviouslyDownloadedMovies);
            ...
            writer.WriteBoolValue("createEmptyMovieFolders", CreateEmptyMovieFolders);
            writer.WriteBoolValue("deleteEmptyFolders", DeleteEmptyFolders);
            writer.WriteEnumValue<global::Soenneker.Radarr.OpenApiClient.Models.ProperDownloadTypes>("downloadPropersAndRepacks", DownloadPropersAndRepacks);
            writer.WriteBoolValue("enableMediaInfo", EnableMediaInfo);
            writer.WriteStringValue("extraFileExtensions", ExtraFileExtensions);
            writer.WriteEnumValue<global::Soenneker.Radarr.OpenApiClient.Models.FileDateType>("fileDate", FileDate);
            ...
            writer.WriteBoolValue("pathsDefaultStatic", PathsDefaultStatic);
            writer.WriteStringValue("recycleBin", RecycleBin);
            writer.WriteIntValue("recycleBinCleanupDays", RecycleBinCleanupDays);
            writer.WriteEnumValue<global::Soenneker.Radarr.OpenApiClient.Models.RescanAfterRefreshType>("rescanAfterRefresh", RescanAfterRefresh);
